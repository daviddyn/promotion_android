...
public class ChinesePronounce {
    ...
    public static final String[] pyStr = new String[] {
    ...
    private static final ChinesePronounce instance = new ChinesePronounce();

    public static ChinesePronounce getInstance() {
        return instance;
    }
    ...
    public String getSelling(String chs) {
        ...
        //判断城市多音字
        if (chs.equals("重庆") || chs.equals("长沙")||chs.equals("长春")) {
            return "C";
        }
